...
![]($withBase/images/Universal/plug-md/processor.png)
...
![]($withBase/images/Universal/plug-md/processor-2.png)

If we then search for instances of `CP00` we find that its full ACPI pathing is `SB.SCK0.CP00`:

![]($withBase/images/Universal/plug-md/cp00.png)
...
![]($withBase/images/Universal/plug-md/plug-bios.png)
...
![]($withBase/images/Universal/plug-md/plug-x299.png)
...
Original          |  Cleaned Up
:-------------------------:|:-------------------------:
![]($withBase/images/Universal/plug-md/ssdt-mess.png)  |  ![]($withBase/images/Universal/plug-md/ssdt-clean.png)
