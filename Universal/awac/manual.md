...
* **Note**: X99 and X299 see [here](/Universal/awac/manual-hedt.md)
...
![]($withBase/images/Universal/awac-md/ACPI000E.png)
...
![]($withBase/images/Universal/awac-md/PNP0B00.png)
...
:-------------------------:|:-------------------------:
![]($withBase/images/Universal/nvram-md/lpc.png)  |  ![]($withBase/images/Universal/nvram-md/pci0.png)
...
![]($withBase/images/Universal/awac-md/ssdt-before.png)
...
![]($withBase/images/Universal/awac-md/ssdt-after.png)
