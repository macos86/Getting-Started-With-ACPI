...
## Tabelle riassuntive (SI PREGA DI OSSERVARE PRIMA LE NOTE IN FONDO ALLA PAGINA; SERVONO A SPIEGARE NEL DETTAGLIO OGNI SSDT)
...
### SSDT-EC-DESKTOP | SSDT-EC-LAPTOP | EC-USBX-DESKTOP | EC-USBX-LAPTOP
...
### CPU-PM | SSDT-PLUG-DRTNIA (by [@gentik84](https://github.com/Gengik84))
